...
namespace SK.WMS.WinControls
{
    ...
    public partial class SKNumericEdit :  C1NumericEdit
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Layout += new System.Windows.Forms.LayoutEventHandler(this.SKNumericEdit_Layout);
            this.GotFocus += new EventHandler(SKNumericEdit_GotFocus);
            this.LostFocus += new EventHandler(SKNumericEdit_LostFocus);
        ...
        void SKNumericEdit_LostFocus(object sender, EventArgs e)
        {
            this.BackColor = ColorVar.DefaultBackColor;
        }

        void SKNumericEdit_GotFocus(object sender, EventArgs e)
        {
        ...
        private void SKNumericEdit_Layout(object sender, LayoutEventArgs e)
        {
